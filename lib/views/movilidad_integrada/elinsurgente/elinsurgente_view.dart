...
class SubElInsurgente extends StatefulWidget {
  const SubElInsurgente({Key? key}) : super(key: key);

  @override
  State<SubElInsurgente> createState() => _SubElInsurgenteState();
}

class _SubElInsurgenteState extends State<SubElInsurgente> {
  bool invertListOrder = false;
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          backgroundColor: const Color(0XFF84302A),
          title: const Text("El Insurgente",
          ...
          bottom: PreferredSize(
            ...
            child: Row(
              ...
              children: [
                invertListOrder
                    ? const Text("Zinacantepec",
                        style: TextStyle(color: Colors.white))
                    : const Text("Observatorio",
                        style: TextStyle(color: Colors.white)),
...
class StationsApi {
  static Future<List<StationData>> getUsersLocally(BuildContext context) async {
    ...
    final data =
        await assetBundle.loadString('assets/data/El_Insurgente/linea_1.json');
