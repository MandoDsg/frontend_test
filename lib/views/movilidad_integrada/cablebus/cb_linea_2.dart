...
import 'package:frontend/views/movilidad_integrada/maps/cablebus_l2_map.dart';
        ...
        appBar: AppBar(
            ...
            IconButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const CablebusL2Map()));
                },
          ...
          bottom: PreferredSize(
            ...
            child: Row(
              ...
              children: [
                invertListOrder
                    ? const Text("Santa Marta",
                        style: TextStyle(color: Colors.white))
                    : const Text("Constitución de 1917",
                        style: TextStyle(color: Colors.white)),
...
class StationsApi {
  static Future<List<StationData>> getUsersLocally(BuildContext context) async {
    ...
    final data =
        await assetBundle.loadString('assets/data/Cablebus/linea_2.json');
