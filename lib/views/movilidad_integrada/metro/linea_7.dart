...
class SubMetroL7 extends StatefulWidget {
  const SubMetroL7({Key? key}) : super(key: key);
        ...
        appBar: AppBar(
          ...
          bottom: PreferredSize(
            ...
            child: Row(
              ...
              children: [
                invertListOrder
                    ? const Text("Barranca del Muerto",
                        style: TextStyle(color: Colors.white))
                    : const Text("El Rosario",
                        style: TextStyle(color: Colors.white)),
...
class StationsApi {
  static Future<List<StationData>> getUsersLocally(BuildContext context) async {
    ...
    final data = await assetBundle.loadString('assets/data/Metro/linea_7.json');
