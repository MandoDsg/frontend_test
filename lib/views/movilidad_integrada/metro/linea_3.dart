...
class SubMetroL3 extends StatefulWidget {
  const SubMetroL3({Key? key}) : super(key: key);

  @override
  State<SubMetroL3> createState() => _SubMetroL3State();
}

class _SubMetroL3State extends State<SubMetroL3> {
  bool invertListOrder = false;
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.lime.shade800,
          title: const Text("Metro - Línea 3",
...
class StationsApi {
  static Future<List<StationData>> getUsersLocally(BuildContext context) async {
    ...
    final data = await assetBundle.loadString('assets/data/Metro/linea_3.json');
