...
class SubMetroL9 extends StatefulWidget {
  const SubMetroL9({Key? key}) : super(key: key);

  @override
  State<SubMetroL9> createState() => _SubMetroL9State();
}

class _SubMetroL9State extends State<SubMetroL9> {
  bool invertListOrder = false;
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.brown.shade900,
          title: const Text("Metro - Línea 9",
...
class StationsApi {
  static Future<List<StationData>> getUsersLocally(BuildContext context) async {
    ...
    final data = await assetBundle.loadString('assets/data/Metro/linea_9.json');
