...
class SubMetroL12 extends StatefulWidget {
  const SubMetroL12({Key? key}) : super(key: key);

  @override
  State<SubMetroL12> createState() => _SubMetroL12State();
}

class _SubMetroL12State extends State<SubMetroL12> {
  bool invertListOrder = false;
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          backgroundColor: const Color(0XFFB9975B),
          title: const Text("Metro - Línea 12",
...
class StationsApi {
  static Future<List<StationData>> getUsersLocally(BuildContext context) async {
    ...
    final data =
        await assetBundle.loadString('assets/data/Metro/linea_12.json');
