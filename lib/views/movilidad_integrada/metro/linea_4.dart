...
class SubMetroL4 extends StatefulWidget {
  const SubMetroL4({Key? key}) : super(key: key);

  @override
  State<SubMetroL4> createState() => _SubMetroL4State();
}

class _SubMetroL4State extends State<SubMetroL4> {
  bool invertListOrder = false;
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          backgroundColor: const Color(0XFF6FB7AE),
          title: const Text("Metro - Línea 4",
          ...
          bottom: PreferredSize(
            ...
            child: Row(
              ...
              children: [
                invertListOrder
                    ? const Text("Santa Anita",
                        style: TextStyle(color: Colors.white))
                    : const Text("Martín Carrera",
                        style: TextStyle(color: Colors.white)),
...
class StationsApi {
  static Future<List<StationData>> getUsersLocally(BuildContext context) async {
    ...
    final data = await assetBundle.loadString('assets/data/Metro/linea_4.json');
